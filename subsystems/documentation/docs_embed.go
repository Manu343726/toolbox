...
//
//go:embed proto/documentation.proto
var documentationProtoSource []byte
...
func init() {
	...
	shareddocs.RegisterEmbeddedProtoSource("proto/documentation.proto", documentationProtoSource)
}
