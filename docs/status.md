...
| API integration                   | Standard description, provider subsystems, catalog with format index, on-demand operation exposure, OpenAPI translation and adapted serving | A provider for each format a user wants; nothing framework-side |
